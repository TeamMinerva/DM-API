  ...
  return (
    <div className="flex h-screen bg-[#FBFCF8]">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        <Topbar />
        <main className="flex-1 p-6 xl:p-8 overflow-y-auto [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
          {error && (
            <p className="text-red-500 text-sm mb-2">
              Erro ao carregar KPIs: {error}
            </p>
          )}
          <div className="flex flex-col gap-4 xl:gap-6 min-h-full">
            <div className={`grid grid-cols-2 xl:grid-cols-4 gap-4 xl:gap-[30px] transition-opacity duration-500 ${loading ? 'opacity-40' : 'opacity-100'}`}>
            ...
            <div className="flex flex-col lg:flex-row gap-4 xl:gap-[30px] flex-1 lg:min-h-[420px] xl:min-h-[500px]">
              <div className="lg:w-[60%] min-h-[380px] lg:min-h-0">
